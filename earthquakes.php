...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(0,0,255);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(0,0,233);" <?php }else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
